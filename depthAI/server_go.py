...
parser.add_argument('--ip', help='IP Camera address and port, EX. --ip 192.168.1.100')
...
device_info = dai.DeviceInfo(ip_addr)
...
while True:
    try:
        ...
        print("Search device and setup again")
        print(type(os.getenv('DEPTHAI_WATCHDOG_INITIAL_DELAY')), os.environ.get('DEPTHAI_WATCHDOG_INITIAL_DELAY'),
            os.environ.get('DEPTHAI_BOOTUP_TIMEOUT'))
        time.sleep(10)
